...
export { postCreateNewUser, getAllUser, putUpdateUser, deleteUser }; // Export dưới dạng Object để có thể export được nhiều biến để sử dụng được nhiều nơi, còn export default chỉ xuất ra có 1 biến mà thôi
